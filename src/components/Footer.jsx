...
const Footer = () => {
    return (
        <footer className="w-full bg-[#222] pt-0 pb-8 px-0 flex flex-col items-center justify-center mt-auto relative overflow-hidden">
                        {/* Imagen de fondo en el footer */}
                        <img src="/IMAGEES/arielfooter.jpg" alt="Ariel Footer" className="w-full object-cover max-h-56 opacity-60 absolute left-0 top-0 z-0" style={{minHeight:'120px'}} />
            ...
            <div className="text-xs text-gray-300 mb-2 relative z-10">© 2026 Made by <a href="https://yeoolabs.com" className="underline hover:text-white" target="_blank" rel="noopener noreferrer">yeoolabs.com</a></div>
